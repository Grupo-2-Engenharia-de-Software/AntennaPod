...
import de.danoeh.antennapod.activity.handler.IntentHandler;
import de.danoeh.antennapod.activity.handler.KeyboardInputHandler;
import de.danoeh.antennapod.activity.manager.DrawerManager;
import de.danoeh.antennapod.activity.manager.NavigationManager;
import de.danoeh.antennapod.activity.manager.PlayerStateManager;
import de.danoeh.antennapod.activity.observer.WorkManagerObserver;
...
public class MainActivity extends CastEnabledActivity {
    ...
    private KeyboardInputHandler.StartupManager startupManager;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        startupManager = new KeyboardInputHandler.StartupManager(this);
